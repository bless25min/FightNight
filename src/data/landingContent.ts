...
export const offersHeroContent = {
  ...
  description:
    '如果你已經受夠每次都把委屈、壓力和害怕吞回去，這頁會把整套邏輯講清楚：為什麼你會越來越撐不住，以及職業格鬥選手是怎麼把恐懼和壓力，慢慢變成可控的。',
  primaryCta: '快速登入查看',
  secondaryCta: '先看這四次內容如何改變你',
}

export const offersCurriculumSectionContent = {
  title: '職業格鬥選手，怎麼把恐懼變成可控',
  subtitle:
    '他們一輩子在練的，不只是打擊能力，而是面對恐懼、管理壓力、撐過打擊、重新站起來的能力。',
  description:
    '職業格鬥選手訓練心理素質的核心，不是叫自己不要怕，而是把恐懼、壓力和混亂，轉成身體可以反覆執行的動作。當呼吸、節奏、步伐、反應都變成你熟悉的東西，人就比較不會一遇到狀況就立刻亂掉。',
...
export const curriculumModules: CurriculumModule[] = [
  {
    ...
    title: '面對恐懼',
    description:
      '不是靠硬撐或靠勇氣，而是在安全但有壓力的情境裡，反覆讓自己留在原地。當身體越來越熟悉那種靠近感與混亂感，恐懼就不再那麼像一個會把你整個人吞掉的東西。',
  },
  {
    id: 'module-2',
    stage: 2,
    title: '管理壓力',
    description:
      '職業選手不會把注意力放在「我是不是快不行了」，而是放在呼吸、節奏、步伐和當下動作。當壓力被拆成一個一個可做的東西，心就比較不容易失控。',
  },
  {
    id: 'module-3',
    stage: 3,
    title: '面對打擊',
    description:
      '被打亂、被逼近、失去節奏，本來就是過程的一部分。重點不是永遠不被擊倒，而是當事情發生時，你能不能先回到結構、先回到呼吸、先回到自己。',
  },
  {
    id: 'module-4',
    stage: 4,
    title: '重新站起來',
    description:
      '真正的底氣不是沒倒過，而是倒過之後知道自己回得來。一次一次在混亂之後重新站穩，最後你帶走的就不只是爽感，而是一種「我撐得住」的信任感。',
  },
]
